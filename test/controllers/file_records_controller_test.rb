...
class FileRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create file_record" do
    assert_difference('FileRecord.count') do
      post file_records_url, params: { file_record: { file: @file_record.file, name: @file_record.name } }
    end
  ...
  test "should update file_record" do
    patch file_record_url(@file_record), params: { file_record: { file: @file_record.file, name: @file_record.name } }
